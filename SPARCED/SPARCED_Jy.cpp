...
void Jy_SPARCED(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        ...
        case 22:
            ...
            break;
        case 23:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_Cdk1, 2)) + 0.5*std::pow(Cdk1 - mCdk1, 2)/std::pow(sigma_Cdk1, 2);
            break;
        case 24:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_Cdk2, 2)) + 0.5*std::pow(Cdk2 - mCdk2, 2)/std::pow(sigma_Cdk2, 2);
            break;
        case 25:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_Cdk46, 2)) + 0.5*std::pow(Cdk46 - mCdk46, 2)/std::pow(sigma_Cdk46, 2);
            break;
        case 26:
        ...
        case 55:
            ...
            break;
        case 56:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_EGFR, 2)) + 0.5*std::pow(EGFR - mEGFR, 2)/std::pow(sigma_EGFR, 2);
            break;
        case 57:
        ...
        case 104:
            ...
            break;
        case 105:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_p18, 2)) + 0.5*std::pow(-mp18 + p18, 2)/std::pow(sigma_p18, 2);
            break;
        case 106:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_p19, 2)) + 0.5*std::pow(-mp19 + p19, 2)/std::pow(sigma_p19, 2);
            break;
        case 107:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_p57, 2)) + 0.5*std::pow(-mp57 + p57, 2)/std::pow(sigma_p57, 2);
            break;
        case 108:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_E2Frep, 2)) + 0.5*std::pow(E2Frep - mE2Frep, 2)/std::pow(sigma_E2Frep, 2);
            break;
        case 109:
