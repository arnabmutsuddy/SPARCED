...
void dJydy_SPARCED(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        ...
        case 22:
            ...
            break;
        case 23:
            dJydy[0] = (1.0*Cdk1 - 1.0*mCdk1)/std::pow(sigma_Cdk1, 2);
            break;
        case 24:
            dJydy[0] = (1.0*Cdk2 - 1.0*mCdk2)/std::pow(sigma_Cdk2, 2);
            break;
        case 25:
            dJydy[0] = (1.0*Cdk46 - 1.0*mCdk46)/std::pow(sigma_Cdk46, 2);
            break;
        case 26:
        ...
        case 55:
            ...
            break;
        case 56:
            dJydy[0] = (1.0*EGFR - 1.0*mEGFR)/std::pow(sigma_EGFR, 2);
            break;
        case 57:
        ...
        case 104:
            ...
            break;
        case 105:
            dJydy[0] = (-1.0*mp18 + 1.0*p18)/std::pow(sigma_p18, 2);
            break;
        case 106:
            dJydy[0] = (-1.0*mp19 + 1.0*p19)/std::pow(sigma_p19, 2);
            break;
        case 107:
            dJydy[0] = (-1.0*mp57 + 1.0*p57)/std::pow(sigma_p57, 2);
            break;
        case 108:
            dJydy[0] = (1.0*E2Frep - 1.0*mE2Frep)/std::pow(sigma_E2Frep, 2);
            break;
        case 109:
